...
var ajax_initialize, ajax_pageUpdate, ajax_processXML, ajax_processText, ajax_updateContent, ajax_unload;
...
(function($,$$) {
     ...
     * @param bwBarsStyle
     */
    ajax_initialize = function(timer, delim, sEnabled, tChangeEnabled, pTitle, glsEnabled, glsSettings, bsEnabled, qActive, xEnabled, uEnabled, uHideOffline, tEnabled, sortEnabled, dsBarStyle, bwBarsEnabled, bwBarsStyle) {
     ...
     * @param content
     */
    ajax_processXML = function(content) {
        alert(content);
    };
     ...
     * @param content
     */
    ajax_processText = function(content) {
        var aryCount = 0;
        if ((bottomStatsEnabled == 1) && (xferEnabled == 1))
            aryCount++;
        if (usersEnabled == 1)
     ...
     */
    ajax_updateContent = function(statsServerStr, statsXferStr, usersStr, transferListStr) {
        if (!statsServerStr) {
            return;
        }
